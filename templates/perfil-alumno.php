...
<head>
    ...
    <!----------------------------------------CONTENIDO------------------------------------------->
        ...
        <!----Datos del pefil (nombre, correo, no. de cuenta, tel)---->
        <div class="cont-general">
            <!----Barra lateral---->
            <!--div de los datos-->
            <div >
                <div id="nomusuario-cont">
                    <p name="nombre-usuario" id="nombre-usuario">Diego Salcedo</p>
                </div>
                <div id="datos-generales">
                    <p name="correo-usuario" text="Email:">ssss@gmail.com</p>
                    <p name="no-cuenta">320300287</p>
                    <p name="telefono">55 5538383837</p>
                </div>
            </div>
        </div>
        <!------------------------FOOTER --------------------------------->
